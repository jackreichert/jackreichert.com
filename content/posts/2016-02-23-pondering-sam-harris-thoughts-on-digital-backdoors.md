---
title: "Pondering Sam Harris’ thoughts on digital backdoors"
date: 2016-02-23
permalink: "/2016/02/23/pondering-sam-harris-thoughts-on-digital-backdoors/"
wp_id: 752
categories: ["Musings"]
post_tags: ["encryption", "privacy", "security"]
description: "Since my last post about encryption vs. security the public debate has exploded due to Tim Cook’s response to the request by the FBI to create a back door in an Apple device. In his most recent podcast Sam Harris weighed in as well. I always look forward to Harris’ perspective on a topic. He […]"
featured_image: "/assets/images/doors-d3fe37f6.jpg"
layout: post
---
...
I’d like to start out by noting that the FBI has not asked Apple to create a backdoor to their encryption; rather, they are asking for a way for them to brute force attack the PIN on the iPhone. This is an important distinction. Creating a backdoor to an implementation of encryption would fundamentally undermine *all* communications and data using that implementation. [This is binary](https://twitter.com/JackReichert/status/702843469522456576), you either *have* secure encryption or you don’t. While their request is *not* for a backdoor into encryption, their request *did* spark a debate on the overall greater topic.
...
*About the image: French Quarter, New Orleans, LA*
